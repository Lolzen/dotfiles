...
our $SCHEMA = [
    ...
    {item => ['urxvt -geometry 97x11+20+873 -e ncmpcpp',         'ncmpcpp',          'undef']},
    #{item => ['urxvt -geometry 110x10+910+353 -e ~/bin/mpdviz --icolor=true --scale=2 --step=8 -v spectrum -d false',         'mpdviz (spectrum)',          'undef']},
    {item => ['urxvt -geometry 97x8+20+738 -e ~/bin/mpdviz --icolor=true --scale=2 --step=8 -v spectrum -d false',         'mpdviz (spectrum)',          'undef']},    
